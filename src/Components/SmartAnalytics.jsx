    ...
    <div className="flex h-screen bg-gradient-to-r from-blue-50 to-blue-100">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'} overflow-hidden flex flex-col`}>
        ...
        <main className="flex-1 p-4 overflow-auto">
          <div className="flex h-full bg-white rounded-3xl shadow-xl p-6 space-x-4">
            
            <div className="flex-1 flex flex-col bg-white rounded-3xl shadow-xl p-6">
            ...
            <div className="flex-1 flex flex-col bg-gray-100 rounded-3xl shadow-xl p-6">
